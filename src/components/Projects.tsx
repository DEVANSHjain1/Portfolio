...
const projects = [
  {
    ...
    year: '2026',
    description: 'An intelligent, asynchronous platform delivering unified, LLM-powered summaries of digital communications across Gmail, Outlook, Slack, and JIRA. Architected for horizontal scaling and fault tolerance.',
    tech: ['Python', 'Pub/Sub', 'MongoDB', 'React', 'Microservices', 'Docker'],
    link: '/projects/01',
  ...
  },
  {
    ...
    category: 'AI & Data\nEngineering',
    year: '2025',
    description: 'A highly concurrent, event-driven discovery engine automating the identification and validation of investment firms. Leverages an asynchronous FastAPI architecture and multi-stage generative AI pipelines for intelligent web scraping and data enrichment at scale.',
  ...
  },
  {
    ...
    year: '2024',
    description: 'A highly-available, event-driven payment processing system. Leverages Temporal.io for fault-tolerant state orchestration and Kafka for asynchronous microservices communication, ensuring reliable transactions at scale.',
    tech: ['Java', 'Spring Boot', 'Temporal.io', 'Kafka', 'MongoDB'],
    link: '/projects/03',
    color: '#FF4D00', // Jade
  }
];
...
const Projects: React.FC = () => {
  ...
  return (
    <section ref={containerRef} id="projects" className="relative bg-gray-50 dark:bg-black text-black dark:text-white min-h-[100vh] py-12 px-4 sm:px-8 font-sans md:px-12 z-20">
      ...
      <div className="max-w-[1920px] mx-auto relative z-10 w-full">
        ...
        <div className="group relative mb-24 md:mb-8 grid grid-cols-1 md:grid-cols-12 gap-x-8 items-start">
          ...
          <div className="col-span-12 md:col-span-2 order-1 md:order-3 md:sticky md:top-32 self-start mb-8 md:mb-0 text-right flex flex-col items-end">
            <span className="text-sm font-mono block mb-2 text-red-600">12 / 2025</span>
        ...
        <div className="group relative mb-4 grid grid-cols-1 md:grid-cols-12 gap-x-8 items-start pb-24">
          {/* Meta (Absolute Left) */}
          <div className="col-span-12 md:col-span-2 md:sticky md:top-32 self-start mb-8 md:mb-0">
            <span className="text-sm font-mono block mb-2 text-red-600">12 / 2024</span>
