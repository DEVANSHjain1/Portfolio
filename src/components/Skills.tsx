  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'GCP(Google Cloud)', level: 85 },
        { name: 'CI/CD', level: 75 },
        { name: 'Terraform / Helm ', level: 70 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Distributed System', level: 85 },
        { name: 'Message Queues (Kafka)', level: 80 },
        { name: 'Data Structure and Algorithm', level: 90 },
        { name: 'LLMs / AI Pipelines', level: 75 },
      ],
    },
  ];
